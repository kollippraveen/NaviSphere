export const stations = {
  ...
  lingampally: {
    ...
    facilities: [
      ...
      { name: "Bridge_J2", x: 74, y: 36, category: "Waypoint", isHidden: true },
      { name: "Bridge_J3", x: 74, y: 53, category: "Waypoint", isHidden: true },
    ]
  },
  medchal: {
    id: "medchal",
    ...
    facilities: [
      ...
      { name: "Stairs P2 Left", x: 43, y: 65, category: "Stairs", isHidden: true },
      { name: "Bridge_J1", x: 46, y: 32, category: "Waypoint", isHidden: true },
      { name: "Bridge_J2", x: 45, y: 53, category: "Waypoint", isHidden: true },
      { name: "Bridge_J3", x: 45, y: 65, category: "Waypoint", isHidden: true },
  ...
  gadwal: {
    ...
    facilities: [
      ...
      { name: "WP_Bridge_P1_Landing", x: 30, y: 40, category: "Waypoint", isHidden: true },
      { name: "WP_Bridge_P2_Landing", x: 70, y: 42, category: "Waypoint", isHidden: true }
    ]
  },
  begumpet: {
    id: "begumpet",
